...
def parse_args():
    ...
    parser.add_argument(
        '--use-huggingface', action='store_true', help='Use Hugging Face instead of original download links'
    )
...
def main():
    ...
    download_utils.libero_dataset_download(
        download_dir=args.download_dir, datasets=args.datasets, use_huggingface=args.use_huggingface
    )
