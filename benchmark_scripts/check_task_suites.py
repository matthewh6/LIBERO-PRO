...
def main():
    ...
    for benchmark_name in [
        ...
        for task_id in range(num_tasks):
            ...
            assert os.path.exists(init_states_path), f'{init_states_path} does not exist!'
    ...
    if count < 130:
        ...
        for demo_file in demo_files:
            if not os.path.exists(os.path.join('benchmark_tasks', demo_file.split('/')[-1].replace('.hdf5', '.png'))):
                print(demo_file)
