...
def create_problem_class_from_file(class_name):
    template_source_file = os.path.join(get_libero_path('benchmark_root'), '../../templates/problem_class_template.py')
...
def create_scene_xml_file(scene_name):
    ...
    template_source_file = os.path.join(get_libero_path('benchmark_root'), '../../templates/scene_template.xml')
