...
def register_task_info(language, scene_name, objects_of_interest=[], goal_states=[]):
    ...
    TASK_INFO[scene_name].append(TaskInfoTuple(scene_name, language, objects_of_interest, task_goal))
    ...
    for scene_name in registered_task_info_dict:
        for task_info_tuple in registered_task_info_dict[scene_name]:
            ...
            try:
                ...
                bddl_file_name = save_to_file(result, scene_name=scene_name, language=language, folder=folder)
