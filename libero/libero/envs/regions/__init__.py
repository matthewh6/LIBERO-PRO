...
REGION_SAMPLERS = {
    ...
    'libero_living_room_tabletop_manipulation': {'living_room_table': Libero100TableRegionSampler},
    'libero_study_tabletop_manipulation': {'study_table': Libero100TableRegionSampler},
    'libero_kitchen_tabletop_manipulation': {'kitchen_table': Libero100TableRegionSampler},
}
...
def update_region_samplers(problem_name, region_sampler_name, region_sampler_class_name):
    ...
    REGION_SAMPLERS[problem_name][region_sampler_name] = eval(f'{problem_name}.{region_sampler_class_name}')
